export default function Footer() {
    ...
    return <footer className="bg-[#28292B] lg:grid lg:grid-cols-5">
        <div className="relative block h-64 lg:col-span-2 lg:h-full">
            <iframe className="absolute inset-0 h-full w-full object-cover"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2254.6499634290835!2d70.82305909518409!3d22.315562852591494!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3959b74a5929d4a3%3A0x70249f1f1d3c6ca6!2sPriti&#39;s%20Cake%20Studio!5e0!3m2!1sen!2sin!4v1737290175087!5m2!1sen!2sin" 
        ...
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
            ...
            <div className="mt-12 border-t border-gray-100 pt-12">
                <p className="mt-8 text-xs text-white sm:mt-0 float-end">
